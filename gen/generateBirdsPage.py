...
def print_header():
	...
	print(inspect.cleandoc("""
		...
		[//]: # (gen-title: Birds {title_pronoun} Photographed{title_year}{title_location})
		
		[//]: # (gen-keywords: bird, photography)
		
		[//]: # (gen-description: Each bird species I've photographed.)
		...
		## Birds {title_pronoun} Photographed{title_year}{title_location}
