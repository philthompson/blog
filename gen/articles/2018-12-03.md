...
1. In another tab in that private/incognito browser window, open my [QR Code Generator](../qrcode.html) page.
...
1. Open my [QR Code Generator](../qrcode.html) page in a private/incognito browser window
