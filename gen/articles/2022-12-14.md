...
So far for part 2 I tried the same script from part 1.  The shell on my Mac, `zsh`, killed the script after it ran for about 18 hours or so, while it was processing the 2nd of 3 blueprints.  I presume it was consuming a ton of memory.
