...
<a name="update-2023-11-15-curve"></a>The biggest change is using a curve, rather than a linear conversion, to map margin of victory (in football points) to Elo score (0.0 for blowout loss, 0.5 for tie, 1.0 for blowout win).
