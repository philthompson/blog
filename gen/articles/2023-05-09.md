...
In this post I'll give some background on the theory and implementation of BLA, and show the performance improvements I'm seeing at some example locations. 
...
To find these coefficients, let's start with the simple case of skipping 0 iterations.  Since <math style="font-size:1.2rem"><mrow><mi>l</mi><mo>=</mo><mn>0</mn></mrow></math> we have:
...
We can intuitively see that the coefficients must be <math style="font-size:1.2rem"><msub><mi>A</mi><mn>0</mn></msub><mo>=</mo><mn>1</mn></math> and <math style="font-size:1.2rem"><msub><mi>B</mi><mn>0</mn></msub><mo>=</mo><mn>0</mn></math>:
...
For "skipping" 1 iteration, we can look at the linear-ized perturbation equation and the bivariate linear approximation equation, and see that the coefficients must be <math style="font-size:1.2rem"><msub><mi>A</mi><mn>1</mn></msub><mo>=</mo><mn>2</mn><mi>Z</mi></math> and <math style="font-size:1.2rem"><msub><mi>B</mi><mn>1</mn></msub><mo>=</mo><mn>1</mn></math>:
...
<!--
- initial auto-epsilon code, difference ratio of test point iteration count of:
	- 1e-3 gives epsilon of 1e-9 (after best found to be 1e-7)
		- this looks mostly fine, but a few pixels here and there are incorrect
	- 1e-4 gives epsilon of 1e-14 (after best found to be 1e-12)
	- 1e-5 gives epsilon of 1e-15 (after best found to be 1e-13)
		- this looks closer to accurate, only a few pixels are incorrect
- after fixing test point locations:
	- 1e-5 gives epsilon of 1e-15 (after best found to be 1e-13)
-->

### Example Location 2

<p class="wrap-wider-child"><a target="_blank" href="${SITE_ROOT_REL}/?plot=Mandelbrot-set&v=5&n=2000000&mag=4.98981260647e152&centerX=-1.928532931364664508128629733239928208230411296677913777145287257081343315454333732943347528524641352140515347513234388519354223613116741857456447761021147175799733212653e0&centerY=2.77503784777739169751349389798092402078848330425867002811249042300236773322474371120872969797094461837014892211874313304811106592251611950572483773205238048198116e-25&gradient=GBswGBswGBsw-G.024269-s.d9794f-mod8000&bgColor=b&smooth=on-show&slopeLightDir=bl&slopeDepth=3&algo=bla-auto"><img class="center-block width-100" src="${SITE_ROOT_REL}/s/img/2023/BLA-example-2.jpg"/></a></p>
...
<!--
- initial auto-epsilon code, difference ratio of test point iteration count of:
	- 1e-5 gives epsilon of 1e-21 (after best found to be 1e-19)
		- this mostly renders the correct image
- after fixing test point locations:
	- 1e-5 gives epsilon of 1e-24 (after best found to be 1e-22)
-->

### Example Location 3

<p class="wrap-wider-child"><a target="_blank" href="${SITE_ROOT_REL}/?plot=Mandelbrot-set&v=5&n=350000&mag=9.5e693&centerX=-1.&centerY=9.-3&gradient=bBdwbBgwbBdw-g.d9af70-b.29305a-d.1c213f-mod700-offset687&bgColor=b&smooth=on-show&slopeLightDir=tl&slopeDepth=4&algo=bla-auto"><img class="center-block width-100" src="${SITE_ROOT_REL}/s/img/2023/BLA-example-3.jpg"/></a></p>
...
* with perturb-sapx8-floatexp: ???
* with perturb-sapx12-floatexp: ???
* with perturb-sapx16-floatexp: ???

And here is an animation showing the effect of changing the value of <math style="font-size:1.2rem"><mi>ε</mi></math>:

<p class="wrap-wider-child"><img class="center-block width-100" src="${SITE_ROOT_REL}/s/img/2023/BLA-example-3-animation.gif"/></p>

<!--
- initial auto-epsilon code, difference ratio of test point iteration count of:
	- 1e-5 gives epsilon of 1e-119 (which is the same number i arrived at in manual testing) (after best found to be 1e-117)
- after fixing test point locations:
	- 1e-5 gives epsilon of 1e-120 (after best found to be 1e-118)
-->


### Example Location 4

<p class="wrap-wider-child"><a target="_blank" href="${SITE_ROOT_REL}/?plot=Mandelbrot-set&v=5&n=8500000&mag=1.02214650766e1744&centerX=-1.&centerY=8.-5&gradient=bBgwo-B.141414-mod200-shift2&bgColor=b&smooth=on-show&algo=bla-auto"><img class="center-block width-100" src="${SITE_ROOT_REL}/s/img/2023/BLA-example-4.jpg"/></a></p>
...
<!--
- after fixing test point locations:
	- 1e-5 gives epsilon of 1e-391 (after best found to be 1e-389) (which is about the same i found)
		- for larger 1600x900 window, at mag=1.8e1744, 1e-5 gives epsilon of 1e-392 (after best of 1e-390 found)
-->

### Example Location 5

<p class="wrap-wider-child"><a target="_blank" href="${SITE_ROOT_REL}/?plot=Mandelbrot-set&v=5&n=50100&mag=1.8e157&centerX=-1.99996619445037030418434688506350579675531241540724851511761922944801584242342684381376129778868913812287046406560949864353810575744772166485672496092803920095332176654843899e0&centerY=3.00138243679093832407249730397759249873468311907733352701742572801204749756148235811856472992884140755192241865049781816254785289455481571221457726813208724311827020946640834e-34&gradient=Bwrw-B.282828-r.BE1428-mod760-offset190&bgColor=b&smooth=on-show&slopeLightDir=tr&slopeDepth=6&algo=bla-auto"><img class="center-block width-100" src="${SITE_ROOT_REL}/s/img/2023/BLA-example-5.jpg"/></a></p>
...
Implementing BLA was a serious challenge for me.  It took several tries, but now Very Plotter is at the point where it's working well enough for the <a target="_blank" href="">v0.10.0 release</a>.  This was a big undertaking, not just for BLA but for this 1200-line blog post as well!
