...
It's worth mentioning that BLA is not yet compatible with stripe average coloring, which was <a href="">recently added to Very Plotter</a>.  This doesn't seem to matter to much because BLA works at very deep locations where stripe average coloring (at least as I've implemented it so far) isn't worth using.
