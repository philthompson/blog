...
I calculated this number over a period of 10 days in the <a target="_blank" href="https://aws.amazon.com/ec2/">Amazon Elastic Compute Cloud</a> using Stanley Dodds's amazing algorithm (see below), which I ported to rust.  In this post I'll give some background on my efforts to compute this value.
